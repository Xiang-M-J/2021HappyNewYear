$(document).ready(function () {
    //加入时钟数字元素 
    const list = "<li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li>";
    var ool = "<ol>" + list + "</ol>";
    $(".spot").after(ool);
    //显示日期
    ...
    $(".date").before(week);
    //显示年度
    const year = "<div class='year'></div>";
    $(".date").before(year);
    //显示时间
    const times = "<div class='times'></div>";
    $(".date").before(times);

    //春节倒计时
    const startTime = new Date("2021/2/12");
    setInterval(function () {
        const nowTime = new Date();
        const time = startTime - nowTime;
        var day, hour,minute,seconds,syday;
        if (time>0){
            day = parseInt(time / 1000 / 60 / 60 / 24);
            hour = parseInt(time / 1000 / 60 / 60 % 24);
            minute = parseInt(time / 1000 / 60 % 60);
            seconds = parseInt(time / 1000 % 60);
            syday = "<span>" + hour + "</span>" + "小时" + "<span>" + minute + "</span>" + "分钟" + "<span class='Lose'>" + seconds + "</span>" + "秒";
            $('.time').html("<p>新年倒计时</p>" + "<p><span>" + day + "</span>" + "天</p>");
            $(".sydate").html(syday);
        }
        else{
            syday="<span  style='font-weight: bold ; font-size: 90px ; color:#ff6c01 ' >"+"新 &nbsp;&nbsp;年 &nbsp;&nbsp;快 &nbsp;&nbsp;乐"+"</span>";
            $(".time").html(syday);
        }
    ...
    var mess = "<span>没想到新年马上就要到了</span><span class='B-span2'>祝你我新年快乐！</span>" +
        "<span>你好2021新的一年。</span><span>2021家人平安，一切顺遂</span><span>新年快乐 万事如意</span>";
    $(".Barrage").append(mess);
